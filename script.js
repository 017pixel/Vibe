document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderStatsScreen() {
        ...
        // --- START: VERBESSERTE Y-ACHSEN-LOGIK ---
        ...
        if (maxMinutesInWeek <= 5) {
            ...
            yAxisMax = Math.ceil(maxMinutesInWeek / 30) * 30; // Runde auf die nächsten 30 Minuten auf
        }
        if (maxMinutesInWeek === 0) yAxisMax = 10; // Standardansicht, wenn keine Daten vorhanden sind
        // --- ENDE: VERBESSERTE Y-ACHSEN-LOGIK ---
